...
export default function AddLooScreen() {
  ...
  const [step, setStep] = useState(0); // 0 = landing, 1 = location, 2 = amenities, 3 = photo
  ...
  async function handleSubmit() {
    ...
    if (!latitude || !longitude) {
      Alert.alert('Error', 'Please use current location or we need coordinates. For now please use the current location button.');
      return;
    }
          ...
          <View style={styles.stepContent}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                ...
                if (!latitude) {
                  Alert.alert('Error', 'Please use the current location button to set coordinates');
                  return;
                }
                setStep(2);
              }}
            ...
            <View style={styles.amenitiesGrid}>
              {AMENITIES.map((a) => (
                ...
                >
                  ...
                  <Text style={[styles.amenityLabel, amenities[a.key] && styles.amenityLabelActive]}>
                    {a.label}
                  </Text>
                </TouchableOpacity>
              ))}
          ...
          <View style={styles.stepContent}>
            ...
            >
              <Text style={styles.submitButtonText}>
                {submitting ? 'Submitting...' : '🚽 Submit Loo!'}
              </Text>
            </TouchableOpacity>
